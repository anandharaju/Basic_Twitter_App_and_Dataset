...
# declare file paths as follows for three files - D:\03_GitWorks\Basic_Twitter_App_and_Dataset\data
telemedicine_tweets = "../data/telemedicine_data.csv"
epilepsy_tweets = "../data/epilepsy_data.csv"
heart_stroke_tweets = "../data/heart_stroke_tweets_data.csv"
